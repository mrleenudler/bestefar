...
Java_no_bestefar_app_BestefarCore_nativeAutoCaptureFeed(JNIEnv* env, jobject,
    ...
    const jdouble v[15] = {
        ...
        probe.bull_width_frac, probe.glare_frac,
        static_cast<jdouble>(probe.glare_ok)};
    jdoubleArray out = env->NewDoubleArray(15);
    env->SetDoubleArrayRegion(out, 0, 15, v);
    return out;
}
